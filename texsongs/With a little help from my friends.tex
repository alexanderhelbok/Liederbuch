...
\begin{enumerate}
\myverse{ \acc{D} What would you \acc{A} do if I \acc{Em} sang out of tune \\ 
...
\myverse{ \acc{D} What do I \acc{A} do when my \acc{Em} love is away \\ 
(does it worry you to \acc{A7} be a\acc{D}lone?)
...
Do you \acc{D} need any\acc{E7}body? \\ 
I \acc{D} need some\acc{C} body to \acc{G} love. \\ 
Could it \acc{D} be any\acc{E7} body? \\ 
I \acc{D} want some\acc{C}body to \acc{G} love. \\ 
Do you \acc{D} need any\acc{E7}body? \\ 
I \acc{D} need some\acc{C} body to \acc{G} love. \\ 
Could it \acc{D} be any\acc{E7} body? \\ 
I \acc{D} want some\acc{C}body to \acc{G} love.

\myverse{ \acc{D} Would you be\acc{A} lieve in a \acc{Em} love at first sight \\ 
yes I’m certain that \\ 
it \acc{A7} happens all the \acc{D} time \\ 
(What do you \acc{A} see when you \\ 
Em turn out the light?)
