...
\usepackage[lmargin=2cm, rmargin=2cm, tmargin=2cm, bmargin=2cm,centering]{geometry}
...
\renewcommand{\title}[1]{%
	...
	\dotuline{\sffamily\Large\textbf{#1}}}
\newcommand{\titlee}[1]{%
	\addcontentsline{toc}{section}{#1 \textbf{\thepage}}
...
\newtcolorbox{mybox}[1]{breakable,pad at break*=1mm, fonttitle=\LARGE , bottomtitle=0.1cm, top=0.35cm, bottom=0.35cm, toptitle=0.1cm, after skip=0.25cm, segmentation style={thick, darkgray!60}, adjusted title={#1}, left=1mm, right=1mm, lines before break=15, enhanced}
